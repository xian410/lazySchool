...
public class RequiresList extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_requires_list);
    ...
    public void getArrayList() throws JSONException {
        ...
        String url = Apiurls.server+Apiurls.selectAllRequires;
        NetUtil.NetListenerT listenerT = new NetUtil.NetListenerT() {
            ...
            public void onResponse(JSONObject response) throws JSONException {
                ...
                if(list.size() == 0) {
                    ...
                    mRvMain.setLayoutManager(new LinearLayoutManager(RequiresList.this));
                    mRvMain.setAdapter(new RequiresAdapter(RequiresList.this,list));
                }else {
